...
from .models import UserMaxAccount, UserAddress
...
class UserUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance:
            ...
            except UserMaxAccount.DoesNotExist:
                user_account = None
                user_address = None
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            user_account, created = UserMaxAccount.objects.get_or_create(user=user) # jodi account thake taile seta jabe user_account ar jodi account na thake taile create hobe ar seta created er moddhe jabe
